...
location_t * localize_measure_step(sensor_t* sensor_data, double left_distance, double right_distance) {
    // dothething();
}
...
void localize_motion_step(double left_distance, double right_distance) {
    // dothething();
}
